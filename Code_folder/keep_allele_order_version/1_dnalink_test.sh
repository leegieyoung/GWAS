...
plink --bfile ${result_folder}/QC/raw_Case --mind 0.2 --make-bed --out ${result_folder}/QC/raw_Case_m
plink --bfile ${result_folder}/QC/raw_Case_m --geno 0.2 --make-bed --out ${result_folder}/QC/raw_Case_m_g
