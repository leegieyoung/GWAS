...
sh ${Code_path}/1-1_Imputed_vcf_to_bfile.sh ADNI1 change
sh ${Code_path}/1-1_Imputed_vcf_to_bfile.sh ADNI_GO2 change
sh ${Code_path}/1-1_Imputed_vcf_to_bfile.sh ADNI3 change
