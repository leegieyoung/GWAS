...
Sample_folder="/scratch/x1997a11/AD_data/BSAD/${Sample}"
Reference_folder="/scratch/x1997a11/REFERENCE/Microarray/beagle/28K"
Reference_bref3="/scratch/x1997a11/REFERENCE/Microarray/beagle/28K"
...
java -Xmx64g -jar ${Beagle_Code_folder}/conform-gt.24May16.cee.jar \
 ref=${Reference_folder}/CHR${Chrom}_annoINFO_Open_28K_190523_2.vcf.gz \
...
java -Xmx64g -jar ${Beagle_Code_folder}/beagle.18May20.d20.jar \
 ref=${Reference_bref3}/CHR${Chrom}_annoINFO_Open_28K_190523_2.beagle.bref3 \
