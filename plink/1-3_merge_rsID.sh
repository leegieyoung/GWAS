...
#missnp 제거
plink --bfile ${GWAS_path}/QC_Imputed_${Sample1}/MaMi/QC_Imputed_${Sample1} \
 --exclude ${GWAS_path}/QC_Imputed_${output}/MaMi/QC_Imputed_${output}-merge.missnp \
 --keep-allele-order \
 --make-bed \
 --allow-no-sex \
...
plink --bfile ${GWAS_path}/QC_Imputed_${output}/QC/NoQC_Imputed_rmmissnp_${output}_g_m_maf \
 ...
 --allow-no-sex \
 --hwe 1e-6 \
 --out ${GWAS_path}/QC_Imputed_${output}/QC/NoQC_Imputed_rmmissnp_${output}_g_m_maf_hwe

cp ${GWAS_path}/QC_Imputed_${output}/QC/NoQC_Imputed_rmmissnp_${output}_g_m_maf_hwe.bed ${GWAS_path}/QC_Imputed_${output}/MaMi/QC_Imputed_rmmissnp_${output}.bed
cp ${GWAS_path}/QC_Imputed_${output}/QC/NoQC_Imputed_rmmissnp_${output}_g_m_maf_hwe.bim ${GWAS_path}/QC_Imputed_${output}/MaMi/QC_Imputed_rmmissnp_${output}.bim
cp ${GWAS_path}/QC_Imputed_${output}/QC/NoQC_Imputed_rmmissnp_${output}_g_m_maf_hwe.fam ${GWAS_path}/QC_Imputed_${output}/MaMi/QC_Imputed_rmmissnp_${output}.fam
